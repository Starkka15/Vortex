...
private:
  ...
  public:
    ...
    /* Reads RGB image from save */
    void readImage(uint32_t width, uint32_t height, bool alpha = false);
    ...
    void setCompression(unsigned short format, uint32_t compressedSize, uint32_t uncompressedSize);
